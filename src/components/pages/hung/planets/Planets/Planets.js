        ...
        <div className="d-flex justify-content-center flex-wrap gap-3 mb-5">
          {planets.map((planet) => (
            <button
              ...
              className={`p-3 rounded-3 glass-effect text-white ${
                styles.planetCard
              } ${selectedPlanet.id === planet.id ? styles.active : ""}`}
            >
              <img
          ...
          <div className="col-lg-6">
            <div className="d-flex flex-column h-100">
              <div className={styles["image-gallery-container"]}>
                <button
                  onClick={prevImage}
                  className="btn btn-dark position-absolute top-50 start-0 translate-middle-y z-1 ms-3"
                >
                  ‹
                </button>
                <img
                ...
                <button
                  onClick={nextImage}
                  className="btn btn-dark position-absolute top-50 end-0 translate-middle-y z-1 me-3"
                >
                  ›
                </button>
              </div>
              <div
                className={`card bg-transparent glass-effect text-white h-100 ${styles.articleCard}`}
              >
