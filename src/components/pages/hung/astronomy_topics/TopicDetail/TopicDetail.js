...
const TopicDetail = () => {
  ...
  return (
    <section
      className="py-5"
      style={{ backgroundColor: "#0c0c2a", marginTop: "3rem" }}
    >
      <div className="container text-white">
        ...
        <img
          src={process.env.PUBLIC_URL + topic.headerImage} // Use the new headerImage property
          alt={topic.title}
        ...
        <div className="col-lg-10 mx-auto">
          ...
          {topic.content && topic.content[0] && (
            <div
              className="mb-5"
              dangerouslySetInnerHTML={{ __html: topic.content[0] }}
            />
          )}

          {topic.gallery &&
            topic.gallery.map((image, index) => {
                ...
                <div className="row g-5 align-items-center my-5" key={index}>
                  ...
                  <div className={`col-md-6 ${imageOrder}`}>
                    <figure className="figure">
                      ...
                      />
                      {image.caption && (
                        <figcaption className="figure-caption text-light-emphasis">
                          {image.caption}
                        </figcaption>
                      )}
                    </figure>
